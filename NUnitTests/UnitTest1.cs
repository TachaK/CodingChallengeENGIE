...
namespace PowerPlantCodingChallenge.Test.Services.Planners
{
    public class BruteForceTreeGenerationProductionPlanPlannerScenarios
    {
        ...
        public void ComputeBestPowerUsage_Wind_Enough()
        {
            ...
            // assert
            Assert.AreEqual(25, result.PowerplantResponses.First(x => x.Name == "Wind1").P);
            NUnit.Framework.Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "Gas1").P);
        }
        ...
        public void ComputeBestPowerUsage_Wind_NotEnough()
        {
            ...
            // assert
            Assert.AreEqual(25, result.PowerplantResponses.First(x => x.Name == "Wind1").P);
            Assert.AreEqual(25, result.PowerplantResponses.First(x => x.Name == "Gas1").P);
        }
        ...
        public void ComputeBestPowerUsage_Wind_TooMuch()
        {
            ...
            // assert
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "Wind1").P);
            Assert.AreEqual(20, result.PowerplantResponses.First(x => x.Name == "Gas1").P);
        }
        ...
        public void ComputeBestPowerUsage_Gas_Efficiency()
        {
            ...
            // assert
            Assert.AreEqual(20, result.PowerplantResponses.First(x => x.Name == "Gas3").P);
            Assert.AreEqual(0, result.PowerplantResponses.Where(x => x.Name != "Gas3").Select(x => x.P).Sum());
        }
        ...
        public void ComputeBestPowerUsage_Gas_AllNeeded()
        {
            ...
            // assert
            Assert.AreEqual(100, result.PowerplantResponses.First(x => x.Name == "Gas1").P);
            Assert.AreEqual(100, result.PowerplantResponses.First(x => x.Name == "Gas2").P);
            Assert.AreEqual(100, result.PowerplantResponses.First(x => x.Name == "Gas3").P);
            Assert.AreEqual(90, result.PowerplantResponses.First(x => x.Name == "Gas4").P);
            Assert.AreEqual(100, result.PowerplantResponses.First(x => x.Name == "Gas5").P);
        }
        ...
        public void ComputeBestPowerUsage_Gas_Pmin()
        {
            ...
            // assert
            Assert.AreEqual(100, result.PowerplantResponses.First(x => x.Name == "Gas2").P);
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "Gas1").P);
        }
        ...
        public void ComputeBestPowerUsage_Kerosine()
        {
            ...
            // assert
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "Gas1").P);
            Assert.AreEqual(25, result.PowerplantResponses.First(x => x.Name == "Kerosine1").P);
        }
        ...
        public void ComputeBestPowerUsage_CO2Impact()
        {
            ...
            // assert
            Assert.AreEqual(150, resultNoCO2.PowerplantResponses.First(x => x.Name == "Gas1").P);
        }
        ...
        public void ComputeBestPowerUsage_TrickyTest1()
        {
            ...
            // assert
            Assert.AreEqual(60, result.PowerplantResponses.Select(x => x.P).Sum());
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "windpark1").P);
            Assert.AreEqual(60, result.PowerplantResponses.First(x => x.Name == "gasfired").P);
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "gasfiredinefficient").P);
        }
        ...
        public void ComputeBestPowerUsage_TrickyTest2()
        {
            ...
            // assert
            Assert.AreEqual(80, result.PowerplantResponses.Select(x => x.P).Sum());
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "windpark1").P);
            Assert.AreEqual(80, result.PowerplantResponses.First(x => x.Name == "gasfired").P);
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "gasfiredinefficient").P);
        }
        ...
        public void ComputeBestPowerUsage_ExamplePayload1_NoCO2()
        {
            ...
            // assert
            Assert.AreEqual(480, result.PowerplantResponses.Select(x => x.P).Sum());
            Assert.AreEqual(90, result.PowerplantResponses.First(x => x.Name == "windpark1").P);
            Assert.AreEqual(21.6, result.PowerplantResponses.First(x => x.Name == "windpark2").P);
            Assert.AreEqual(368.4, result.PowerplantResponses.First(x => x.Name == "gasfiredbig1").P);
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "gasfiredbig2").P);
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "gasfiredsomewhatsmaller").P);
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "tj1").P);
        }
        ...
        public void ComputeBestPowerUsage_ExamplePayload2_NoCO2()
        {
            ...
            Assert.AreEqual(480, result.PowerplantResponses.Select(x => x.P).Sum());
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "windpark1").P);
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "windpark2").P);
            Assert.AreEqual(380, result.PowerplantResponses.First(x => x.Name == "gasfiredbig1").P);
            Assert.AreEqual(100, result.PowerplantResponses.First(x => x.Name == "gasfiredbig2").P);
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "gasfiredsomewhatsmaller").P);
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "tj1").P);
        }
        ...
        public void ComputeBestPowerUsage_ExamplePayload3_NoCO2()
        {
            ...
            // assert
            Assert.AreEqual(910, result.PowerplantResponses.Select(x => x.P).Sum());
            Assert.AreEqual(90, result.PowerplantResponses.First(x => x.Name == "windpark1").P);
            Assert.AreEqual(21.6, result.PowerplantResponses.First(x => x.Name == "windpark2").P);  
            Assert.AreEqual(460, result.PowerplantResponses.First(x => x.Name == "gasfiredbig1").P);
            Assert.AreEqual(338.4, result.PowerplantResponses.First(x => x.Name == "gasfiredbig2").P);
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "gasfiredsomewhatsmaller").P);
            Assert.AreEqual(0, result.PowerplantResponses.First(x => x.Name == "tj1").P);
        }
    }
